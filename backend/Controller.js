...
import ZeitSensorData from './ZeitSensorData.js';
import WetterData from './WetterData.js';
import WarnungData from './WarnungData.js';
...
export class SensorDataController {
    ...
    async holeUndVerarbeiteWetterdaten() {
        try {
            ...
            console.error("Fehler beim Laden der Wetterdaten:", error.response?.data || error.message);
        }
    }
...
(async () => {
    ...
    console.log("=== Login ===")
    console.log(await controller.tryLogin("test1234","test123"))
